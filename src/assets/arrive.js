...
var Arrive = (function (window, $, undefined) {
  ...
  var utils = (function () {
    ...
    return {
      ...
      checkChildNodesRecursively: function (
        nodes,
        registrationData,
        matchFunc,
        callbacksToBeCalled
  ...
  var MutationEvents = function (getObserverConfig, onMutation) {
    ...
    this.addTimeoutHandler = function (
      target,
      selector,
      callback,
      options,
  ...
  var ArriveEvents = function () {
    ...
    function onArriveMutation(mutations, registrationData) {
      mutations.forEach(function (mutation) {
        ...
        if (newNodes !== null && newNodes.length > 0) {
          ...
          if (
            nodeMatchFunc(targetNode, registrationData, callbacksToBeCalled)
          ) {
            callbacksToBeCalled.push({
              callback: registrationData.callback,
              elem: targetNode,
    ...
    arriveEvents = new MutationEvents(
      getArriveObserverConfig,
      onArriveMutation
    );
    ...
    arriveEvents.bindEvent = function (selector, arg2, arg3) {
      var options =
        typeof arg2 === "object"
          ? utils.mergeArrays(arriveDefaultOptions, arg2)
          : { ...arriveDefaultOptions };
      var callback =
      ...
      if (!callback) options.onceOnly = true;
      ...
      if (callback) {
        ...
        return new Promise((resolve) =>
          mutationBindEvent.call(a, selector, options, resolve)
        );
      }
    };
  ...
  var LeaveEvents = function () {
    ...
    leaveEvents.bindEvent = function (selector, arg2, arg3) {
      var options =
        typeof arg2 === "object"
          ? utils.mergeArrays(leaveDefaultOptions, arg2)
          : { ...leaveDefaultOptions };
      var callback =
        typeof arg3 === "function"
          ? arg3
  ...
  function exposeUnbindApi(eventObj, exposeTo, funcName) {
    ...
    utils.addMethod(
      exposeTo,
      funcName,
      eventObj.unbindEventWithSelectorOrCallback
    );
    utils.addMethod(
      exposeTo,
      funcName,
      eventObj.unbindEventWithSelectorAndCallback
    );
  }
